...
[cols=2*]
|===
^|https://fwd.aws/yJgMp[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/YAMYy[View template^]
^|https://fwd.aws/3rp53[Deploy {partner-product-short-name} into an existing VPC on AWS^]
