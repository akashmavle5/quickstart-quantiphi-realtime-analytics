...
*** Publish metadata to an Amazon API Gateway with WebSocket API.
...
*** Publish transcripts and keyword data to the web application through the WebSocket.
...
* Amazon API Gateways with WebSocket API to provide access to the web application.
